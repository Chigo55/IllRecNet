...
<!-- Wiki-Optimizer Rules for Codex CLI (AGENTS.md) -->
<wiki_optimizer_instructions>

## MANDATORY: Wiki-First Protocol

이 프로젝트는 wiki-optimizer를 사용합니다. 토큰 절감을 위해 아래 규칙을 반드시 따르세요.
