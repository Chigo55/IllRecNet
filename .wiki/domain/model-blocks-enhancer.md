...
## 연결
- [[.wiki/model-blocks-separation]] — 분리 블록 의존.
- [[.wiki/model-blocks-attention]] — 어텐션 블록 의존.
- [[.wiki/model-blocks-flatten]] — 텐서 차원 변형 의존.
- [[.wiki/model-blocks-sampling]] — 업/다운 샘플링 블록 의존.
