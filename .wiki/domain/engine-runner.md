...
- **`_build_datamodule`**: [[.wiki/data-dataloader]] 객체 초기화.
...
## 연결
- [[.wiki/engine-engine]] — 이 러너 클래스들을 인스턴스화하고 실행하는 엔진.
- [[.wiki/data-dataloader]] — `_build_datamodule`에서 활용.
- [[.wiki/utils-utils]] — `save_images` 기능 사용.
